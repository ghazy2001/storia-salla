    ...
    >
      <div className="max-w-6xl mx-auto">
        <div className="flex justify-between items-end mb-12">
          ...
          <h1
            className={`text-4xl md:text-5xl font-serif italic text-right ${
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
          ...
          <div className="lg:col-span-2">
            {step === "shipping" ? (
              ...
              >
                ...
                >
                  <h3
                    className={`text-2xl font-serif italic mb-6 text-right ${theme === "green" ? "text-brand-charcoal" : "text-white"}`}
                  >
                    طريقة الدفع
                  </h3>
              ...
              <div className="space-y-8 animate-in fade-in slide-in-from-left-4 duration-500">
                ...
                >
                  <div className="flex justify-between items-center mb-8">
                    ...
                    <h3
                      className={`text-2xl font-serif italic text-right ${theme === "green" ? "text-brand-charcoal" : "text-white"}`}
                    >
                      بيانات الدفع
                    </h3>
                  </div>
          ...
          >
            <div className="mb-6 text-right">
              ...
              <p
                className={`text-xl font-serif ${theme === "green" ? "text-brand-charcoal" : "text-white"}`}
              >
                {orderId}
              </p>
            </div>
            ...
            <h3
              className={`text-2xl font-serif italic mb-8 text-right ${theme === "green" ? "text-brand-charcoal" : "text-white"}`}
            >
              ملخص الطلب
            </h3>
            ...
            <div className="space-y-4 mb-8">
              {cartItems.map((item) => (
                ...
                >
                  <p
                    className={`font-serif text-right mb-1 ${theme === "green" ? "text-brand-charcoal" : "text-white"}`}
                  >
                    {item.name}
                  </p>
                  <p
